...
import argparse, subprocess, os, os.path

#$(AM_V_GEN) $(CPP) -I$(top_builddir) -I$(top_builddir)/simd $(srcdir)/jsimdcfg.inc.h
# | $(EGREP) "^[\;%]|^\ %"
...
if __name__ == '__main__':
    ...
    parser.add_argument('-I', dest='includes', nargs=1, action='append',
                        help='An include to pass on to CPP')
    parser.add_argument(dest='in_file', nargs=1, type=str,
                        help='in file')
    parser.add_argument(dest='out_file', nargs=1, type=str,
                        help='out file')
